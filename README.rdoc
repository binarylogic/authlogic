...
You do this JUST LIKE you do for any other model. The actions are exactly the same as well:

  $ script/generate controller user_sessions

[Here are the contents of this controller](http://github.com/binarylogic/authlogic_example/blob/5819a13477797d758cb6871f475ed1c54bf8a3a7/app/controllers/user_sessions_controller.rb).

Notice it's exactly the same as any other resource controller.

=== 6. Map a resource to your UserSessionsController

Again, this is exactly the same as any other controller:
...
Again, this is application specific. You can do this however you wish. For an example [see the ApplicationController](http://github.com/binarylogic/authlogic_example/blob/5819a13477797d758cb6871f475ed1c54bf8a3a7/app/controllers/application_controller.rb) in the authlogic example app. Also, checkout the before_filters in the other controllers. Restricting access is as simple as that. There are a million ways to do this, but this seems to be the most common.
