...
*	<b>Official Authlogic OpenID addon:</b> http://github.com/binarylogic/authlogic_openid
*	<b>Live example with OpenID & source code:</b> http://authlogicexample.binarylogic.com
