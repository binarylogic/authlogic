    ...
    module Callbacks
      ...
      def self.included(base) #:nodoc:
        ...
        if Gem::Version.new(ActiveSupport::VERSION::STRING) >= Gem::Version.new('5')
          base.define_callbacks(*METHODS + [{ :terminator => ->(_target, result_lambda) { result_lambda.call == false } }])
          base.define_callbacks('persist', terminator: ->(_target, result_lambda) { result_lambda.call == true })
